  ...
  return (
    <Wrapper>
      ...
      <TextContainer>
        ...
        <h3>What's wrong with a manager delivering anonymized feedback?</h3>
        <Spacer direction="y" multiple={1} />
        <p>The process of making feedback anonymous removes details and for feedback to be effective it needs to be
          specific. That means details! Another downside to this approach is that it misses the opportunity for a team
          to
          grow closer by working through tough situations together openly and also by praising each other directly.</p>

        <Spacer direction="y" multiple={2} />

        <h3>What's good about anonymized feedback?</h3>
        <Spacer direction="y" multiple={1} />
      ...
      <TextContainer>
        <p>Whenever you want! Although, this tool's intended use is to be run during a 360 performance review cycle
          after
